...
type NeedleLocation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PileId          uint64 `protobuf:"varint,1,opt,name=pile_id,json=pileId,proto3" json:"pile_id,omitempty"`
	Offset          uint64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	AggregatedProof []byte `protobuf:"bytes,3,opt,name=aggregated_proof,json=aggregatedProof,proto3" json:"aggregated_proof,omitempty" ssz-size:"48"`
}

func (x *NeedleLocation) Reset() {
	*x = NeedleLocation{}
	if protoimpl.UnsafeEnabled {
...
func (x *NeedleLocation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NeedleLocation) ProtoMessage() {}

func (x *NeedleLocation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_blobs_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NeedleLocation.ProtoReflect.Descriptor instead.
func (*NeedleLocation) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_blobs_proto_rawDescGZIP(), []int{1}
}

func (x *NeedleLocation) GetPileId() uint64 {
	if x != nil {
		return x.PileId
	}
	return 0
...
func (x *NeedleLocation) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *NeedleLocation) GetAggregatedProof() []byte {
	if x != nil {
		return x.AggregatedProof
	}
	return nil
...
var file_proto_prysm_v1alpha1_blobs_proto_rawDesc = []byte{
	...
	,
...
var file_proto_prysm_v1alpha1_blobs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_prysm_v1alpha1_blobs_proto_goTypes = []interface{}{
	(*BlobsSidecar)(nil),   // 0: ethereum.eth.v1alpha1.BlobsSidecar
	(*NeedleLocation)(nil), // 1: ethereum.eth.v1alpha1.NeedleLocation
	(*v1.Blob)(nil),        // 2: ethereum.engine.v1.Blob
}
var file_proto_prysm_v1alpha1_blobs_proto_depIdxs = []int32{
	2, // 0: ethereum.eth.v1alpha1.BlobsSidecar.blobs:type_name -> ethereum.engine.v1.Blob
