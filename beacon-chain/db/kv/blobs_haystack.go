...
const blobSidecarKeyLength_Haystack = 48 // slot_to_rotating_buffer(blob.slot) ++ blob.slot ++ blob.block_root

type Haystack struct {
	*Store
}

func (h *Haystack) LocateNeedle(ctx context.Context, beaconBlockRoot [32]byte) (*ethpb.NeedleLocation, error) {
	ctx, span := trace.StartSpan(ctx, "BeaconDB.LocateNeedle")
	defer span.End()
	var enc []byte
...
//     bucket.put(key, blob)
func (s *Store) SaveBlobsSidecar_Haystack(ctx context.Context, blobSidecar *ethpb.BlobsSidecar) error {
...
func (s *Store) BlobsSidecar_Haystack(ctx context.Context, beaconBlockRoot [32]byte) (*ethpb.BlobsSidecar, error) {
...
func (s *Store) BlobsSidecarsBySlot_Haystack(ctx context.Context, slot types.Slot) ([]*ethpb.BlobsSidecar, error) {
...
func (s *Store) DeleteBlobsSidecar_Haystack(ctx context.Context, beaconBlockRoot [32]byte) error {
...
func blobSidecarKey_Haystack(blob *ethpb.BlobsSidecar) []byte {
